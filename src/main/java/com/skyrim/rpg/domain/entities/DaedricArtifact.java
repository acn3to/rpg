...
public class DaedricArtifact  extends Item{
    ...
    public DaedricArtifact(int id, String name, String description, int value, EffectEnum effect, List<Skill> specialSkills) {
        super(id, name, description, value, effect);
